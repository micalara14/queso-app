...
const ItemCart = () => {
    ...
    return (
        ...
        <div className="item-cart">
            ...
            {cart.length > 0 ?  <div> <p className="total-compra" >Total de su compra: ${total}</p> <Button onClick={() => deleteAll()} variant="warning"> Vaciar carrito </Button> {/* <Button onClick={createOrder} variant="warning"> Crear orden </Button> */} <ItemForm/> </div> : null}
        </div>
